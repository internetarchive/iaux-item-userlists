 ...
 */const ge=window,Je=ge.ShadowRoot&&(ge.ShadyCSS===void 0||ge.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Xe=Symbol(),rt=new WeakMap;let wt=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==Xe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Je&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=rt.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&rt.set(t,e))}return e}toString(){return this.cssText}};const At=o=>new wt(typeof o=="string"?o:o+"",void 0,Xe),h=(o,...e)=>{const t=o.length===1?o[0]:e.reduce((i,r,n)=>i+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+o[n+1],o[0]);return new wt(t,o,Xe)},Bt=(o,e)=>{Je?o.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),r=ge.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=t.cssText,o.appendChild(i)})},ot=Je?o=>o:o=>o instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return At(t)})(o):o;/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function xe(o){return M({...o,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;let Ke=class extends S{constructor(){super(...arguments),this.config=new Ge}render(){return w`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?w`<div class="logo-icon">${yi}</div>`:$}
    ...
    `}get backdropTemplate(){return $}backdropClicked(){this.dropdown.open=!1,this.backdropVisible=!1}dropdownClicked(){this.backdropVisible=this.dropdown.open}render(){return w`
  ...
  `;a([M({type:String})],U.prototype,"item",void 0);a([xe()],U.prototype,"selectedCount",void 0);a([xe()],U.prototype,"userListData",void 0);a([xe()],U.prototype,"backdropVisible",void 0);a([xe()],U.prototype,"userListsService",void 0);a([j("ia-dropdown")],U.prototype,"dropdown",void 0);U=a([I("ia-item-user-lists")],U);let Ze=class extends S{render(){return w`
      <div>
