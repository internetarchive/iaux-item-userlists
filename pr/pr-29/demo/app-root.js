...
fill=""></path>
    ...
    `}static get styles(){const e=f`var(--dropdownBorderWidth, 1px)`,t=f`var(--dropdownBorderRadius, 4px)`,i=f`var(--dropdownBorderColor, #fff)`,r=f`var(--dropdownBgColor, #333)`,n=f`var(--dropdownTextColor, #fff)`,o=f`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,l=f`var(--dropdownSelectedBgColor, #fff)`,a=f`var(--dropdownMainButtonBgColor, transparent)`,u=f`var(--dropdownTextAlign, inherit)`,h=f`var(--dropdownBackdropZIndex, 1)`,g=f`var(--dropdownListZIndex, 2)`;return f`
      :host {
        display: inline;
        color: ${n};
      }
