...
`;let Ke=class extends S{constructor(){super(...arguments),this.config=new me}render(){return w`
    ...
    `}};a([M({type:String,reflect:!0})],te.prototype,"mode",void 0);a([M({type:Object})],te.prototype,"customModalContent",void 0);a([M({type:Object})],te.prototype,"hostBridge",void 0);a([j("modal-template")],te.prototype,"modalTemplate",void 0);te=a([I("modal-manager")],te);async function xi(o,e){let t=document.querySelector("modal-manager");if(!t){const i=document.querySelector("body");t=document.createElement("modal-manager"),i==null||i.appendChild(t)}t==null||t.setAttribute("id","create-user-list-modal"),t.showModal({config:new me({title:w`List settings`,headerColor:"#194880",showCloseButton:!0,showHeaderLogo:!1,closeOnBackdropClick:!0}),customModalContent:w`
      ...
      ></iaux-userlist-settings>
    `})}let ue=class extends S{constructor(){super(...arguments),this.item="",this.lists=[]}get checkIcon(){return J`<svg viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
