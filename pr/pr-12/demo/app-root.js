 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var Te;((Te=window.HTMLSlotElement)===null||Te===void 0?void 0:Te.prototype.assignedElements)!=null;const ft=h`var(--white, #fff)`,qt=h`var(--primaryDisableCTAFill, #767676)`,Wt=h`var(--secondaryCTABorder, #999)`,Gt=h`var(--primaryCTAFill, #194880)`,Oe=h`var(--primaryCTAFillRGB, 25, 72, 128)`,Kt=h`var(--primaryCTABorder, #c5d1df)`,Zt=h`var(--primaryErrorCTAFill, #d9534f)`,Ue=h`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Jt=h`var(--primaryErrorCTABorder, #d43f3a)`,Xt=h`var(--secondaryCTAFill, #333)`,Re=h`var(--secondaryCTAFillRGB, 51, 51, 51)`,Qt=h`var(--primaryCTABorder, #979797)`,Yt=h`#ee8950`,ei=h`#ec7939`,ti=h`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${ft};
...
`;let Ke=class extends S{constructor(){super(...arguments),this.config=new Ge}render(){return m`
    ...
    `}get backdropTemplate(){return $}backdropClicked(){this.dropdown.open=!1,this.backdropVisible=!1}dropdownClicked(){this.backdropVisible=this.dropdown.open,this.dropdown.open&&(this.dropdown.focus(),this.initUserLists())}render(){return m`
