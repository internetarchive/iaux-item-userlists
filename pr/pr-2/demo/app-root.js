 ...
 */var Te;((Te=window.HTMLSlotElement)===null||Te===void 0?void 0:Te.prototype.assignedElements)!=null;let k=class extends S{constructor(){super(...arguments),this.open=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.openViaCaret=!0,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.isCustomList=!1,this.closeOnEscape=!1,this.boundKeyboardListener=e=>{switch(e.key){case"Escape":case"Esc":this.open=!1;break}},this.handlingCaretClick=!1}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeKeyboardListener()}setupKeyboardListener(){this.closeOnEscape&&document.addEventListener("keydown",this.boundKeyboardListener)}removeKeyboardListener(){this.closeOnEscape&&document.removeEventListener("keydown",this.boundKeyboardListener)}get dropdownState(){return this.open?(this.setupKeyboardListener(),"open"):(this.removeKeyboardListener(),"closed")}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.addEventListener("closeDropdown",()=>{this.open=!1})}renderOption(e){const{label:t,url:i=void 0,id:r}=e;let n;const s=this.selectedOption===r?"selected":"";return i?n=m`<a
    ...
    `}};a([$({type:Boolean,attribute:!0})],k.prototype,"open",void 0);a([$({type:Boolean,attribute:!0})],k.prototype,"displayCaret",void 0);a([$({type:Boolean,attribute:!0})],k.prototype,"closeOnSelect",void 0);a([$({type:Boolean,attribute:!0})],k.prototype,"openViaButton",void 0);a([$({type:Boolean,attribute:!0})],k.prototype,"openViaCaret",void 0);a([$({type:Boolean,attribute:!0})],k.prototype,"includeSelectedOption",void 0);a([$({type:String,attribute:!0})],k.prototype,"selectedOption",void 0);a([$({type:Array})],k.prototype,"options",void 0);a([$({type:String})],k.prototype,"optionGroup",void 0);a([$({type:Function})],k.prototype,"optionSelected",void 0);a([$({type:Boolean,reflect:!0})],k.prototype,"isCustomList",void 0);a([$({type:Boolean,reflect:!0})],k.prototype,"closeOnEscape",void 0);a([ie(".click-main")],k.prototype,"mainButton",void 0);k=a([R("ia-dropdown")],k);let ze=class extends S{render(){return m`
...
`;let Ge=class extends S{constructor(){super(...arguments),this.config=new we}render(){return m`
      <div class="modal-wrapper">
        <div class="modal-container">
          <header style="background-color: ${this.config.headerColor}">
            ${this.config.showCloseButton?this.closeButtonTemplate:""}
            ${this.config.showHeaderLogo?m`<div class="logo-icon">${yi}</div>`:M}
    ...
    `}static get styles(){const e=h`var(--modalLogoSize, 6.5rem)`,t=h`var(--processingImageSize, 7.5rem)`,i=h`var(--modalCornerRadius, 1rem)`,r=h`var(--modalBorder, 2px solid black)`,n=h`var(--modalBottomMargin, 2.5rem)`,s=h`var(--modalTopMargin, 5rem)`,d=h`var(--modalHeaderBottomPadding, 0.5em)`,c=h`var(--modalBottomPadding, 2rem)`,v=h`var(--modalScrollOffset, 5px)`,f=h`var(--modalTitleFontSize, 1.8rem)`,g=h`var(--modalSubtitleFontSize, 1.4rem)`,_=h`var(--modalHeadlineFontSize, 1.6rem)`,x=h`var(--modalMessageFontSize, 1.4rem)`,B=h`var(--modalTitleLineHeight, normal)`,L=h`var(--modalSubtitleLineHeight, normal)`,A=h`var(--modalHeadlineLineHeight, normal)`,j=h`var(--modalMessageLineHeight, normal)`;return h`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};a([$({type:Object})],Ge.prototype,"config",void 0);Ge=a([R("modal-template")],Ge);function $i(o,e,t){var i=t||{},r=i.noTrailing,n=r===void 0?!1:r,s=i.noLeading,d=s===void 0?!1:s,c=i.debounceMode,v=c===void 0?void 0:c,f,g=!1,_=0;function x(){f&&clearTimeout(f)}function B(A){var j=A||{},I=j.upcomingOnly,Ce=I===void 0?!1:I;x(),g=!Ce}function L(){for(var A=arguments.length,j=new Array(A),I=0;I<A;I++)j[I]=arguments[I];var Ce=this,tt=Date.now()-_;if(g)return;function ve(){_=Date.now(),e.apply(Ce,j)}function it(){f=void 0}!d&&v&&!f&&ve(),x(),v===void 0&&tt>o?d?(_=Date.now(),n||(f=setTimeout(v?it:ve,o))):ve():n!==!0&&(f=setTimeout(v?it:ve,v===void 0?o-tt:o))}return L.cancel=B,L}var z;(function(o){o.Open="open",o.Closed="closed"})(z||(z={}));class Mi{constructor(e){this.windowResizeThrottler=$i(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case z.Open:this.startResizeListener(),this.stopDocumentScroll();break;case z.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let ee=class extends S{constructor(){super(...arguments),this.mode=z.Closed,this.hostBridge=new Mi(this),this.closeOnBackdropClick=!0}render(){return m`
      <div class="container">
    ...
    `}};a([$({type:String,reflect:!0})],ee.prototype,"mode",void 0);a([$({type:Object})],ee.prototype,"customModalContent",void 0);a([$({type:Object})],ee.prototype,"hostBridge",void 0);a([ie("modal-template")],ee.prototype,"modalTemplate",void 0);ee=a([R("modal-manager")],ee);async function xi(o){let e=document.querySelector("modal-manager");if(!e){const t=document.querySelector("body");e=document.createElement("modal-manager"),t==null||t.appendChild(e)}e==null||e.setAttribute("id","create-user-list-modal"),e.showModal({config:new we({title:m`List settings`,headerColor:"#194880",showCloseButton:!0,showHeaderLogo:!1,closeOnBackdropClick:!0}),customModalContent:m`
      <iaux-userlist-settings
        .userList=${{id:void 0,list_name:"",description:"",is_private:!1}}
        .userListsService=${o}
        @listModalClosed=${()=>{e.showModal({config:new we,customModalContent:void 0}),e.closeModal()}}
        @userListSaved=${async t=>{window.dispatchEvent(new CustomEvent("createUserList",{detail:{created:t.detail},bubbles:!0,composed:!0})),window.dispatchEvent(new CustomEvent("closeDropdown",{bubbles:!0,composed:!0})),e.showModal({config:new we,customModalContent:void 0}),e.closeModal()}}
      ></iaux-userlist-settings>
    `})}let ue=class extends S{constructor(){super(...arguments),this.identifier="",this.lists=[]}get checkIcon(){return Z`<svg viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ${t}
        ...
        </ia-icon-label>`,id:i.id,selectedHandler:n=>this.onSelected(n)};e.push(r)});const t={label:m`<ia-icon-label>
        <div slot="icon">${this.plusIcon}</div>
        Create new list
      </ia-icon-label>`,id:"create-new-list",selectedHandler:()=>this.createList()};return e.push(t),e}async createList(){await xi(this.userListsService)}onSelected(e){let t=0;this.lists=this.lists.map(i=>(i.id===e.id&&(i.item_is_member=!i.item_is_member,i.item_is_member),i.item_is_member&&(t+=1),i)),this.dispatchEvent(new CustomEvent("selectDropdown",{detail:{selected:t},bubbles:!0,composed:!0})),this.closeDropdown()}closeDropdown(){this.dispatchEvent(new CustomEvent("closeDropdown",{bubbles:!0,composed:!0}))}render(){return m`
  ...
  `;a([$({type:String})],F.prototype,"item",void 0);a([Xe()],F.prototype,"selectedCount",void 0);a([Xe()],F.prototype,"userListData",void 0);a([Xe()],F.prototype,"userListsService",void 0);F=a([R("ia-item-user-lists")],F);let Ke=class extends S{render(){return m`
      <div>
