...
`;let Ke=class extends S{constructor(){super(...arguments),this.config=new me}render(){return w`
    ...
    >
      ${t}
        ...
        Create new list
      </ia-icon-label>`,id:"create-new-list",selectedHandler:()=>this.createList()};return e.push(t),e}async createList(){await xi(this.userListsService,()=>this.closeDropdown())}async addMember(e){var t;await((t=this.userListsService)===null||t===void 0?void 0:t.addMemberToList(e,{identifier:this.itemId}))}async removeMember(e,t){var i;await((i=this.userListsService)===null||i===void 0?void 0:i.removeMemberFromList(e,t))}async onSelected(e){var t;let i=0;const r=this.lists.find(s=>e.id===s.id)||{},n=(t=r.members)===null||t===void 0?void 0:t.find(s=>s.identifier===this.itemId);n?(await this.removeMember(r.id,n.member_id),i-=1):(await this.addMember(r.id),i+=1),this.dispatchEvent(new CustomEvent("selectDropdown",{detail:{selected:i},bubbles:!0,composed:!0})),this.closeDropdown()}closeDropdown(){this.dispatchEvent(new CustomEvent("closeDropdown",{bubbles:!0,composed:!0}))}render(){return w`
    ...
    `}get backdropTemplate(){return this.backdropVisible?w`
      <div
        class="click-backdrop"
        @click=${this.backdropClicked}
        @keypress=${this.backdropClicked}
      ></div>
    `:$}backdropClicked(){this.dropdown.open=!1,this.backdropVisible=!1}dropdownClicked(){this.backdropVisible=this.dropdown.open}render(){return w`
